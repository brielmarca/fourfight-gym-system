...
public class StudentProfileController {
    ...
    public ResponseEntity<StaffStudentProfileResponse> getByUserId(@PathVariable UUID userId) {
        return ResponseEntity.ok(studentProfileService.getStaffViewByUserId(userId));
    }
