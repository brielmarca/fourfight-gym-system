        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-zinc-300">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>O utilizador é responsável pela confidencialidade da palavra-passe e da sessão.</li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2">
              O utilizador pode criar conta e manifestar interesse através de pré-inscrição/pré-venda.
              A pré-inscrição, por si só, não corresponde necessariamente a uma adesão paga ativa.
            </p>
            <p className="mt-2">
              Enquanto a ativação total de pagamentos online estiver em fase de transição, a conclusão
              da adesão pode ocorrer por contacto WhatsApp ou presencialmente na receção.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Os planos, preços e condições podem ser apresentados no site para informação comercial.
              A disponibilidade final de cada adesão pode depender de confirmação de pagamento,
              validação administrativa e capacidade operacional da academia.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              Quando os pagamentos online estiverem ativos, o processamento é efetuado pela Stripe. A
              aplicação da academia não armazena dados completos de cartão bancário.
            </p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              Enquanto a configuração live estiver pendente, podem existir fluxos de pagamento manual
              ou presencial na receção.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Pedidos de cancelamento e eventuais reembolsos devem ser tratados pelos canais oficiais
              da academia (email/receção), de acordo com a lei aplicável e com a política comercial em
              vigor no momento do pedido.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white">8. Área de aluno e área administrativa</h2>
            <p className="mt-2">
              O acesso a áreas reservadas depende do perfil, estado de conta e permissões atribuídas.
              Não é permitido tentar aceder a áreas sem autorização.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white">9. Conteúdos e uploads de professores/admin/equipa</h2>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              incidentes técnicos, falhas de fornecedores de alojamento/infraestrutura ou serviços de
              terceiros.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              4Four Fight Academy ou a entidades que autorizaram a sua utilização. Qualquer utilização
