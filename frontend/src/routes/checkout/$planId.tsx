  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === "STRIPE") {
      ...
      try {
        ...
        setError(
          err instanceof Error ? err.message : "Nao foi possivel ativar o plano. Tente novamente.",
        );
      } finally {
        setSubmitting(false);
      }
    ...
    if (paymentMethod === "RECECAO") {
      ...
      try {
        ...
        setSuccessMessage(
          response.message ||
            "Pedido enviado. A sua adesao ficara pendente ate aprovacao na rececao.",
        );
      } catch (err) {
        setError(
          err instanceof Error ? err.message : "Nao foi possivel enviar o pedido para aprovacao.",
        );
      } finally {
        setSubmitting(false);
      }
      ...
      <main className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            <Card
              className="bg-surface border-border-subtle md:sticky md:top-8"
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <CardDescription>Presencialmente na academia</CardDescription>
                        </div>
                      </div>
                    </Label>
                  </RadioGroup>
                  ...
                  <p className="text-xs text-text-secondary text-center">
                    Ao prosseguir, concorda com os nossos Termos de Servico e Politica de
                    Privacidade.
                  </p>
                </form>
              </CardContent>
